                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <?php elseif ($page_name == 'restaurant/edit') : ?>
                            <a href="<?php echo site_url('site/restaurant/' . rawurlencode(sanitize($restaurant_data['slug'])) . '/' . sanitize($restaurant_data['id'])); ?>" class="btn btn-outline-primary btn-rounded float-right ml-1" name="button" target="_blank"><i class="fas fa-external-link-alt"></i> <?php echo get_phrase("view_restaurant_in_frontend", true); ?></a>
                            <a href="<?php echo site_url('restaurant'); ?>" class="btn btn-outline-primary btn-rounded float-right" name="button"><?php echo get_phrase("back_to_restaurants", true); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
