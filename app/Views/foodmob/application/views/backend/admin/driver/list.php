        ...
        <div class="col-lg-4">
          <div class="form-group">
            ...
            <select class="form-control select2 w-100" name="status">
              <option value="approved" <?php if (sanitize($status) == "approved") echo "selected"; ?>><?php echo get_phrase('approved'); ?></option>
              <option value="pending" <?php if (sanitize($status) == "pending") echo "selected"; ?>><?php echo get_phrase('pending'); ?></option>
            </select>
          </div>
        </div>
        <div class="col-1">
