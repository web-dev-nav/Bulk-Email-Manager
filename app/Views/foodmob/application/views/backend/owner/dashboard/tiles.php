    ...
    <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">
                    <?php echo count($this->restaurant_model->get_approved_restaurant_ids_by_owner_id($this->session->userdata('user_id'))); ?>
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">
                    <?php echo count($this->restaurant_model->get_pending_restaurant_ids_by_owner_id($this->session->userdata('user_id'))); ?>
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">
                    <?php echo count($this->driver_model->get_approved_drivers()); ?>
                </span>
            </div>
        </div>
    </div>
