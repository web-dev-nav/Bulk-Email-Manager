        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="card card-secondary">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="<?php echo site_url('ingredient/store'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="ingredient_name" class="form-control" name="ingredient_name" placeholder="<?php echo get_phrase("enter_ingredient_name"); ?>" value="">
                            </div>
                            <div class="form-group">
                                <label for="unit"><?php echo get_phrase("unit"); ?> <span class="text-danger">*</span></label>
                                <input type="text" id="unit" class="form-control" name="unit" placeholder="<?php echo strtolower(get_phrase("kilogram")); ?>, <?php echo strtolower(get_phrase("gram")); ?>, <?php echo strtolower(get_phrase("pound")); ?>, <?php echo strtolower(get_phrase("ounce")); ?>, <?php echo get_phrase("piece"); ?> etc" value="">
                            </div>
                            <div class="form-group">
                                <label for="unit_price"><?php echo get_phrase("price_per_unit") . ' (' . currency_code_and_symbol('code') . ')'; ?> <span class="text-danger">*</span></label>
                                <input type="number" class="form-control" id="unit_price" name="unit_price" placeholder="<?php echo get_phrase('enter_unit_price'); ?>" step="0.01" min="0">
                            </div>
